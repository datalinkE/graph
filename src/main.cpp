...
int main()
{
    ...
    */
    ...
    //const char SAMPLE_GRAPH_FILE[] = "../input_files/SampleTestData.txt";
    //const char SAMPLE_GRAPH_FILE[] = "../input_files/TinyDataDouble.txt";
    const char SAMPLE_GRAPH_FILE[] = "../input_files/10000EWG.txt";
	...
	::cout << ::endl << "== PAUSE == Press Enter to continue..." << ::endl;
	::cin.get();
    return 0;
}
